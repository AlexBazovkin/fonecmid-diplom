...
**Важно**: установка конфигураций и обновлений должна осуществляться квалифицированными специалистами. Во избежание потери данных и работоспособности системы рекомендуем предоставить процесс настройки сотрудникам нашей компании. Для дополнительной информации свяжитесь с вашим менеджером в компании "СовТех".

Инструкция по первоначальной настройке находится [здесь](https://github.com/AlexBazovkin/fonecmid-diplom/blob/main/Инструкции%20и%20файлы/Первоначальная%20настройка.md).

Инструкция по созданию телеграм бота и группы [здесь](https://github.com/AlexBazovkin/fonecmid-diplom/blob/main/Инструкции%20и%20файлы/Настройка%20телеграм%20бота%20и%20группы.md).

Инструкция по установке значений констант [здесь](https://github.com/AlexBazovkin/fonecmid-diplom/blob/main/Инструкции%20и%20файлы/Установка%20значений%20констант.md).
