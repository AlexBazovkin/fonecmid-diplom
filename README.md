...
**Примечание**: используйте заданный порядок инструкций.

[1. Первоначальная настройка конфигурации](https://github.com/AlexBazovkin/fonecmid-diplom/blob/main/Инструкции%20и%20файлы/Первоначальная%20настройка.md).

[2. Создание телеграм бота и группы](https://github.com/AlexBazovkin/fonecmid-diplom/blob/main/Инструкции%20и%20файлы/Настройка%20телеграм%20бота%20и%20группы.md).

[3. Установка значений констант](https://github.com/AlexBazovkin/fonecmid-diplom/blob/main/Инструкции%20и%20файлы/Установка%20значений%20констант.md).
